...
imagem_copa_homens
#ggplot2::ggsave("C:/Users/italo/Downloads/imagem_copa_homens.png", plot = imagem_copa_homens, dpi = 300)
```
```{r}
grafico_copa_homens <-
    ggplot(
    ...
    labs(
        ...
        Fonte: CBF: https://www.cbf.com.br/futebol-brasileiro/noticias/index/as-selecoes-campeas-mundiais-desde-1930")
grafico_copa_homens
#ggplot2::ggsave("C:/Users/italo/Downloads/grafico_copa_homens.png", plot = grafico_copa_homens, dpi = 300)
```
...
imagem_copa_mulheres <-
  ...
  ggsankey::theme_sankey(
    ...
    labs(
        title = "Campeãs da Copa do Mundo Feminina",
            subtitle = "1991 - 2022",
                caption = "by Ítalo Monteiro
...
imagem_copa_mulheres
#ggplot2::ggsave("C:/Users/italo/Downloads/imagem_copa_mulheres.png", plot = imagem_copa_mulheres, dpi = 300)
```
